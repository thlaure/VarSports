 ...
 */
final class Version20240716194835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club ADD city_id INT DEFAULT NULL, ADD postal_code_id INT DEFAULT NULL, DROP cityfk_id, DROP postal_codefk_id, DROP postal_code, DROP city');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club ADD cityfk_id INT DEFAULT NULL, ADD postal_codefk_id INT DEFAULT NULL, ADD postal_code VARCHAR(5) DEFAULT NULL, ADD city VARCHAR(255) DEFAULT NULL, DROP city_id, DROP postal_code_id');
